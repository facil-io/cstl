...
#define FIO_MAP_NAME umap           /* Development inclusion - ignore line */
...
SFUNC FIO_MAP_TYPE FIO_NAME(FIO_MAP_NAME, get)(FIO_MAP_PTR map,
                                               FIO_MAP_HASH hash,
                                               FIO_MAP_OBJ_KEY key);

/** Sets a value in the map, overwriting existing data if any. */
SFUNC FIO_MAP_TYPE FIO_NAME(FIO_MAP_NAME, set)(FIO_MAP_PTR map,
                                               FIO_MAP_HASH hash,
#ifdef FIO_MAP_KEY
                                               FIO_MAP_KEY key,
#endif /* FIO_MAP_KEY */
 ...
 */
  ...
  for (size_t i = 1; i < MEMBERS; ++i) {
    ...
    FIO_ASSERT((FIO_MAP_TYPE)i ==
               ...
               i);
#endif
    FIO_ASSERT(FIO_MAP_TYPE_CMP(old, FIO_MAP_TYPE_INVALID),

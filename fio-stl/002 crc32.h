...
Provides fast CRC32 computation using slicing-by-8 for ~4-8x throughput
...
/* *****************************************************************************
Slicing-by-8 CRC32 tables (polynomial 0xEDB88320, little-endian reflected)

Table 0 is the standard byte-at-a-time CRC32 table.
Tables 1-7 are derived: table[t][i] = table[0][table[t-1][i] & 0xFF]
                                       ^ (table[t-1][i] >> 8)
***************************************************************************** */

/* clang-format off */
static const uint32_t fio___crc32_table[8][256] = {
...
/* *****************************************************************************
CRC32 Implementation — slicing-by-8
***************************************************************************** */

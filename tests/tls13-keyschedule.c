...
FIO_SFUNC void fio___test_tls13_hkdf_expand_label_basic(void) {
  ...
  FIO_LOG_DEBUG("TLS 1.3 HKDF-Expand-Label basic test: PASSED");
}
...
FIO_SFUNC void fio___test_tls13_derive_secret_basic(void) {
  ...
  FIO_LOG_DEBUG("TLS 1.3 Derive-Secret basic test: PASSED");
}
...
FIO_SFUNC void fio___test_tls13_rfc8448_key_schedule(void) {
  ...
  FIO_LOG_DEBUG("  Handshake Secret: PASSED");
  ...
  FIO_LOG_DEBUG("  Client HS Traffic Secret: PASSED");
  ...
  FIO_LOG_DEBUG("  Server HS Traffic Secret: PASSED");
  ...
  FIO_LOG_DEBUG("  Client HS Key/IV: PASSED");
  ...
  FIO_LOG_DEBUG("  Server HS Key/IV: PASSED");
  ...
  FIO_LOG_DEBUG("  Master Secret: PASSED");
  ...
  FIO_LOG_DEBUG("  Client App Traffic Secret: PASSED");
  ...
  FIO_LOG_DEBUG("  Server App Traffic Secret: PASSED");
  ...
  FIO_LOG_DEBUG("  Client App Key/IV: PASSED");
  ...
  FIO_LOG_DEBUG("  Server App Key/IV: PASSED");

  FIO_LOG_DEBUG("TLS 1.3 RFC 8448 Key Schedule: ALL PASSED");
}
...
FIO_SFUNC void fio___test_tls13_finished_key(void) {
  ...
  FIO_LOG_DEBUG("TLS 1.3 Finished Key derivation: PASSED");
}
...
FIO_SFUNC void fio___test_tls13_traffic_update(void) {
  ...
  FIO_LOG_DEBUG("TLS 1.3 Traffic Secret Update: PASSED");
}
...
FIO_SFUNC void fio___test_tls13_sha384_variant(void) {
  ...
  FIO_LOG_DEBUG("TLS 1.3 SHA-384 variant: PASSED");
}
...
FIO_SFUNC void fio___test_tls13_determinism(void) {
  ...
  FIO_LOG_DEBUG("TLS 1.3 Determinism: PASSED");
}
...
FIO_SFUNC void fio___test_tls13_edge_cases(void) {
  ...
  FIO_LOG_DEBUG("TLS 1.3 Edge Cases: PASSED");
}
...
***************************************************************************** */
int main(void) {
  FIO_LOG_INFO("Testing TLS 1.3 Key Schedule (RFC 8446 Section 7.1)...\n");

  FIO_LOG_INFO("=== Basic Functionality Tests ===");
  fio___test_tls13_hkdf_expand_label_basic();
  fio___test_tls13_derive_secret_basic();

  FIO_LOG_INFO("=== RFC 8448 Test Vectors ===");
  fio___test_tls13_rfc8448_key_schedule();

  FIO_LOG_INFO("=== Finished Key Tests ===");
  fio___test_tls13_finished_key();

  FIO_LOG_INFO("=== Traffic Update Tests ===");

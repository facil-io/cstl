/* *****************************************************************************
Debug fio_p256_keypair vs point_mul for the secret it actually uses.
***************************************************************************** */
#define FIO_LOG
...
int main(void) {
  ...
  /* Third validation: confirm fio_p256_keypair itself agrees with OpenSSL
   * before checking the manual point_mul path. */

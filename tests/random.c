 ...
 */
#define FIO_DEFINE_RANDOM_FUNCTION2(extern, name, reseed_log, seed_offset)     \
  ...
  FIO_IFUNC fio_u128 name##128(void) {                                         \
    ...
    r = t = name##___state;                                                    \
    t.u64[0] += FIO_U64_HASH_PRIME0;                                           \
    t.u64[1] += FIO_U64_HASH_PRIME1;                                           \
    t.u64[2] += FIO_U64_HASH_PRIME2;                                           \
    t.u64[3] += FIO_U64_HASH_PRIME3;                                           \
...
FIO_DEFINE_RANDOM_FUNCTION2(FIO_SFUNC, ex, 24, 0)

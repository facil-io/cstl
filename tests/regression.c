...
FIO_SFUNC void FIO_NAME_TEST(stl, regression_memchr_small_lengths)(void) {
...
FIO_SFUNC void FIO_NAME_TEST(stl, regression_json_comments)(void) {
...
FIO_SFUNC void FIO_NAME_TEST(stl, regression_ed25519_negative_carry)(void) {
  ...
  for (int i = 0; i < 10; ++i) {
    ...
    size_t msg_len = FIO_STRLEN(message);
...
FIO_SFUNC void FIO_NAME_TEST(stl, regression_aes_gcm_unaligned)(void) {
...
int main(void) {
  ...
  FIO_NAME_TEST(stl, regression_memchr_small_lengths)();

  /* Part 2: JSON comment parsing */
  FIO_NAME_TEST(stl, regression_json_comments)();

  /* Part 3: Ed25519 negative carry */
  FIO_NAME_TEST(stl, regression_ed25519_negative_carry)();

  /* Part 4: AES-GCM unaligned access */
  FIO_NAME_TEST(stl, regression_aes_gcm_unaligned)();
  return 0;
}
